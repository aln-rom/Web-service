        ...
        <q-card flat class="my-card col-4 q-col-gutter-xs q-my-xl q-py-xl">
          ...
          <q-tab-panels v-model="tab" animated>
            <q-tab-panel name="login">
              ...
              <a  href="https://accounts.google.com/signin/oauth/identifier?client_id=217991563041-24mhrqea2jnlv4gjrgbddrfqhdqoo84v.apps.googleusercontent.com&as=bT2hZIkqgjWs3q-RFJC45w&destination=http%3A%2F%2F127.0.0.1%3A8081&approval_state=!ChRfRWZBdHFFZ05aVnJhVGVKYzkyLRIfNDBkNlRhRXNWVkFiOERFdWhZOThQYzlGQmNCQUJ4Yw%E2%88%99AF-3PDcAAAAAXlRGPHzndtrpRkICBLBIivRirriChT20&oauthgdpr=1&xsrfsig=ChkAeAh8T-LcE7sQsxB8hN56rmAyqwZTBosYEg5hcHByb3ZhbF9zdGF0ZRILZGVzdGluYXRpb24SBXNvYWN1Eg9vYXV0aHJpc2t5c2NvcGU&flowName=GeneralOAuthFlow">
              ...
              <a href="https://oauth.vk.com/authorize?client_id=7334753&redirect_uri=http%3A%2F%2F127.0.0.1%3A8081%2Fsuccess&scope=email&response_type=code">
            ...
            <q-tab-panel name="registration">
              ...
              <q-btn color="yellow" class="q-my-md" @click="getPassword" size="16px"  style="width: 100%" label="Далее" />
            </q-tab-panel>
          </q-tab-panels>
        </q-card>
      </div>
          ...
          <div class="col-4">
            <q-card flat class="my-card col-4 q-col-gutter-xs q-my-xl q-py-xl">
              ...
              <div class="q-gutter-sm">
                <q-radio keep-color v-model="user.gender"
                         val="male" label="Мужской" color="yellow" />
                <q-radio keep-color v-model="user.gender" val="female" label="Женский" color="yellow" />
              </div>
              <q-input outlined type="text" class=" q-my-md"
                       @input="$v.user.first_name.$touch()"
                       :rules="[
                        val => $v.user.first_name.required || 'Имя слишком короткое'
                        ]"
                       v-model.trim="user.first_name" placeholder="Имя..." />
